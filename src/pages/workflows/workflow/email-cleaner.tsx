import { Badge, Button, createStyles, Flex, List, Text, Title } from "@mantine/core";
      ...
      <Flex direction="column" align="center" className={classes.section} gap={10}>
        <Flex align="center" gap={8}>
          <h1 className={classes.title}>
            Zero Inbox Email Cleaner
          </h1>
          <Badge color={"dark"} variant="outline">Popular</Badge>
        </Flex>
        <stripe-buy-button
        ...
        <Text c="dimmed" align="center" style={{ 
          ...
          <Text size="lg" mb="md"><Text weight={700} span={true} style={{ color: '#1e293b' }}>Email Cleaner:</Text> <Text span={true} style={{ color: '#3730a3', fontWeight: 600 }}>$1 Million USD</Text></Text>
          <Text size="lg" mb="md"><Text weight={700} span={true} style={{ color: '#1e293b' }}>Sales:</Text> <Text span={true} style={{ color: '#059669', fontWeight: 600 }}>1 Million Shares</Text></Text>
          <Text size="lg" mb="md"><Text weight={700} span={true} style={{ color: '#1e293b' }}>Accounting:</Text> <Text span={true} style={{ color: '#dc2626', fontWeight: 600 }}>100,000 at $1 each</Text></Text>
        </Text>
      </Flex>
